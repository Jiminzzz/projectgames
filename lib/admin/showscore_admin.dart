...
// import 'dart:ffi';
import 'package:flutter/material.dart';
import 'package:games/admin/showscore_adapter_admin.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:shared_preferences/shared_preferences.dart';

class showscore_admin extends StatefulWidget {
  const showscore_admin({super.key});
  @override
  State<showscore_admin> createState() => _showscore_adminState();
}

class _showscore_adminState extends State<showscore_admin> {
  //--------------------------------------------เรียก Admin -------------------------------------------------------//
  String Email = "";
  String Name = "";
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return showscore_adapter_admin(child: classname);
                  },
                ),
              ),
//--------------------------------------------------------------------------------------------------------------//
